...
export-env {
    ...
    let virtual_env = '/Users/waynebell/Library/Mobile Documents/com~apple~CloudDocs/Ivy Tech College Docs/Semester 2/software development - python/programs/api /venv'
    let bin = 'bin'
